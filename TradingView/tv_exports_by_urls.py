...
SCREEN_URLS = [
    "https://www.tradingview.com/screener/SSOqQTWL/",
    "https://www.tradingview.com/screener/gyjiUSJS/",
    "https://www.tradingview.com/screener/rnzZa3T3/",
]
...
def main(headless: bool = False):
    ...
    with sync_playwright() as p:
        ...
        for url in SCREEN_URLS:
            ...
            filename = f"{safe_filename(screener_name)}_{slug}_{run_date}.csv"
