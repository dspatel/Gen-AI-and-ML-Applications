...
## v5 (2026-01-20)
- Added per-symbol candle debug logging (CSV) to verify the exact bars being pulled/evaluated (helps diagnose timezone and 1-candle-shift issues)
- Debug logs are written to output/LIVE or output/TEST and include OR levels, armed state, and evaluation reasons per candle pair
