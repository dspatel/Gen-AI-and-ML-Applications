...
SCREENS_TO_EXPORT = [
    "Price between SMA100 and SMA200",
...
H2_SELECTOR = "#js-screener-container > div.root-wANuhlbW > div > div.wrapper-zsIRv5zF > div.topbar-k3vjdDEs > div.actionsContainer-lwa7RDR1 > div > h2"
