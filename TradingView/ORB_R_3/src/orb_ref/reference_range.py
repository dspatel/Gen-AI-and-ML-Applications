...
def build_reference_range(or_rows: list[dict], include_today_or: bool = False) -> dict:
    ...
    return {
        # Whether the *current session* OR was included in this reference calculation.
        # (We compute this upstream and pass it here; default False keeps unit tests simple.)
        "includes_today_or": bool(include_today_or),
