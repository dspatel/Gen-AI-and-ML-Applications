...
- `DISCORD_SEND_EOD_ALERTS_CSV`: upload the full `scan_alerts_YYYY-MM-DD.csv` to Discord as an attachment
- `DISCORD_UPLOAD_CSV_ONLY_IF_ALERTS`: if True, only upload the CSV when alerts_count > 0
