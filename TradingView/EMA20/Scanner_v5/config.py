...
class CFG:
    ...
    # =========================
    DISCORD_ENABLED: bool = (os.getenv("EMA_DISCORD_ENABLED", "").lower() in ("1","true","yes")) if os.getenv("EMA_DISCORD_ENABLED", "") != "" else True
    ...
    DISCORD_SEND_STARTUP_BANNER: bool = True # notification on script start
