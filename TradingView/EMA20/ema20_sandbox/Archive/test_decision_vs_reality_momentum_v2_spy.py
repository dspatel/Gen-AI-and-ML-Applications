# ============================================================
# Module F-M v2 (LOUD): Decision vs Reality Analyzer (Momentum v2)
# ============================================================

from __future__ import annotations

print("✅ MODULE F-M v2 STARTED")  # guaranteed print
...
def main():
    ...
    signals_path = os.path.join(os.getcwd(), "data", "SPY_30d_5m_yahoo_ema20_orb_signals_momentum_v2.csv")
    trades_path = os.path.join(os.getcwd(), "data", "SPY_trades_momentum_v2.csv")
    out_path = os.path.join(os.getcwd(), "data", "SPY_decision_vs_reality_momentum_v2.csv")

    print("\n[Module F-M v2] Loading signals + trades...")
    ...
    print(f"\n✅ Saved decision vs reality (momentum v2) to: {out_path}")
