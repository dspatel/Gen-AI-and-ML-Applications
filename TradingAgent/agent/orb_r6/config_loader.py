...
def load_config(path: str = "config.yaml") -> AppConfig:
    ...
    research_output_dir = str(paths.get("research_output_dir", "./artifacts/orb_r6/research"))
    cache_source_db_path = str(paths.get("cache_source_db_path", "./orb_research.db"))
    ...
    market_data = MarketDataConfig(
        ...
        provider=str(md.get("provider", "alpaca")).strip().lower(),
    ...
    return AppConfig(
        ...
        cache_source_db_path=cache_source_db_path,
        timezone=timezone,
